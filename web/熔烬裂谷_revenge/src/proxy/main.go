...
func main() {
	...
	router.GET("/query", func(c *gin.Context) {
		...
		fmt.Printf("curl %s\n", url)
		if !(strings.HasPrefix(url, "http://") || strings.HasPrefix(url, "https://") || strings.HasPrefix(url, "gopher")) {
			c.JSON(http.StatusBadRequest, gin.H{
